...
# GeoFlare — Fire Detection Engine (Web map + AI)

Detection side of the system: predict whether there is a fire from environmental sensor
data (tabular Random Forest) and from images (CNN), exposed through a real-time firewall
map web app.
