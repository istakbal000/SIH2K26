...
MODEL_FILE = (
    MODEL_DIR
    / "agricultural_fire_random_forest_v2.pkl"
)

PREDICTION_FILE = (
    RESULT_DIR
    / "agriculture_test_predictions_2021_v2.csv"
)

IMPORTANCE_FILE = (
    RESULT_DIR
    / "agriculture_feature_importance_v2.csv"
)
...
print("\n================================================")
print("AGRICULTURAL FIRE CLASSIFIER V2")
print("RANDOM FOREST")
print("================================================")


# ============================================================
# LOAD 2020 TRAINING DATA
# ============================================================

print("\nLoading 2020 V2 training dataset...")
...
print("\nLoading 2021 V2 testing dataset...")
...
print("\n================================================")
print("TESTING V2 ON UNSEEN 2021 DATA")
print("================================================")
...
prediction_df[
    "predicted_agricultural_fire"
] = y_pred


prediction_df[
    "agricultural_fire_probability"
] = agricultural_probability
